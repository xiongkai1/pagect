...
import deStyles from './designMaterialPage.less';
    ...
    render() {
        ...
        return (
            <div className={styles.fontsPage}>
                <div className={styles.topBox}>
                    <Carousel autoplay className={styles.carousel}>
                        <div className={styles.carouselDiv}>
                            <img width="100%" height="100%" src={require('../../../images/banner5.png')}/>
                        </div>
                        <div className={styles.carouselDiv}>
                ...
                <HotRecommendation typeActiveKey={5}></HotRecommendation>
            </div>
        );
    }
}

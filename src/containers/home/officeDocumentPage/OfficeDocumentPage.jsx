...
import deStyles from '../designMaterialPage/designMaterialPage.less';
    ...
    render() {
        ...
        return (
            <div className={styles.fontsPage}>
                <div className={styles.topBox}>
                    <Carousel autoplay className={styles.carousel}>
                        <div className={styles.carouselDiv}>
                            <img width="100%" height="100%" src={require('../../../images/banner6.png')}/>
                        </div>
                        <div className={styles.carouselDiv}>
                                    ...
                                    fontList.map(item => {
                                        return (
                                            <Col key={item.key} className={styles.gutterBox} span={6}>
                                                <div  className={deStyles.itemBox}>
                                                    <img width="100%" height="400px" src={item.value}/>
                                                </div>
                                            </Col>
                                        );
                                    })
                ...
                <HotRecommendation typeActiveKey={6}></HotRecommendation>
            </div>
        );
    }
}

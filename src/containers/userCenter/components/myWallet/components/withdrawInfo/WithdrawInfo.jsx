...
import styles from './withdrawInfo.less';
import WithdrawBar from './components/WithdrawBar';
import OrderTable from '../../../orderTable/OrderTable';

export default class WithdrawInfo extends Component {
    state = {
        columns: [
            {
                title: '序号',
    ...
    render() {
        ...
        return (
            <div className={styles.withdrawInfo}>
                <div className={styles.withdrawTopPart}>
                    <WithdrawBar/>
                </div>
                <div className={styles.withdrawContentPart}>
                    <OrderTable

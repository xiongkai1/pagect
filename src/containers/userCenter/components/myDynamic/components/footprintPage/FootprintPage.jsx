...
export default class FootprintPage extends Component {
    state = {
        activeKey: '1',
        tabInfo: [
            {
    ...
    render() {
        let { activeKey, tabInfo, listData, paginationParams, viewActiveKey, viewTab } = this.state;
                        ...
                        tabInfo.map(item => {
                            return (
                                <div 
                                    ...
                                    onClick={() => this.changeActiveKey(item.key, 'date')}
                                >
                                    {item.text}
                                </div>
                            );
                    ...
                    }
                    {
                        viewTab.map(item => {
                            return (
                                <div 
                                    key={item.key} 
                                    className={cls(styles.tabItem, viewActiveKey === item.key ? styles.activeItem : null)}
                                    onClick={() => this.changeActiveKey(item.key, 'view')}
                                >
                                    {item.text}
                                </div>
                            );

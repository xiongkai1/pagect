            ...
            render: (text, record, index) => {
                ...
                recor = <div className={styles.state}>
                    <div className={styles.grounding}>
                        <Button onClick={groundingClick.bind(record.id)} size="small" type={record.commodityStatus === '5' ? 'danger' : null}>上架</Button>
                        <Button onClick={undercarriageClick.bind(record.id)} size="small" type={record.commodityStatus === '6' ? 'danger' : null}>下架</Button>
                    </div>
